...
#	required = True,
#	default = None, 
#	help = "Places a cut to establish a sideband definition")
...
positive_MinPhoton_mvaID = [event_scores for event_scores in events["MinPhoton_mvaID"] if event_scores >= 0.0]
positive_MaxPhoton_mvaID = [event_scores for event_scores in events["MaxPhoton_mvaID"] if event_scores >= 0.0]

events["positive_MinPhoton_mvaID"] = positive_MinPhoton_mvaID
events["positive_MaxPhoton_mvaID"] = positive_MaxPhoton_mvaID

# 3. Make a function to make a plot of signal, MC, and data with ratio panel below 
def make_ratio_plot(data, mc, mc_weight, gg_mc, gg_mc_weight, hh_ggbb_mc, hh_ggbb_mc_weight, ttgg_mc, ttgg_mc_weight, ttg_mc, ttg_mc_weight, vh_mc, vh_mc_weight, wgamma_mc, wgamma_mc_weight, zgamma_mc, zgamma_mc_weight, gjets_mc, gjets_mc_weight, tthh_ggbb, tthh_ggbb_weight, tthh_ggWW, tthh_ggWW_weight, tthh_ggTauTau, tthh_ggTauTau_weight, save_name, **kwargs):
	...
	hist_stack = [h_hh_ggbb_mc, h_vh_mc, h_ttgg_mc, h_zgamma_mc, h_wgamma_mc, h_ttg_mc, h_gg_mc, h_gjets_mc]
...
#		"positive_MaxPhoton_mvaID" : {"bins" : "40,-1,1", "x_label" : "Max Photon MVA ID"},
		"MinPhoton_mvaID" : {"bins" : "40,-1,1", "x_label" : "Min Photon MVA ID"},
		"positive_MinPhoton_mvaID" : {"bins" : "40,-1,1", "x_label" : "Min Photon MVA ID"},
	...
	for column, plot_info in plots.items(): 
		...
		plot_info["save_name"] = "/home/users/kmartine/public_html/plots/Fall_2021/log_%s_%s_dataMC.pdf" %(presel_name, column)
		...
		plot_info["save_name"] = "/home/users/kmartine/public_html/plots/Fall_2021/linear_%s_%s_dataMC.pdf" %(presel_name, column)
